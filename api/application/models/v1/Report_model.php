...
class Report_model extends CI_Model {
    ...
    function get_real_plan_cities($filter, $order, $limit, $offset)
    {
        ...
        $additional = ["city_id_TYPE_int_CLAUSE_IN", "account_base_label_TYPE_text", "city_label_TYPE_text", "account_object_plan_amount_TYPE_int", "account_object_real_amount_TYPE_int"];
    ...
    function get_recapitulation_cities($filter, $order, $limit, $offset)
    {
        ...
        $additional = ["city_id_TYPE_int_CLAUSE_IN", "account_object_label_TYPE_text", "city_label_TYPE_text", "account_object_plan_amount_TYPE_int", "account_object_real_amount_TYPE_int"];
        $filter = set_filter($filter, "", $additional);
        $order = set_order($order);
        $limit_offset = set_limit_offset($limit, $offset);
